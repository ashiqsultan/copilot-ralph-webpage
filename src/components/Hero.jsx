...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      {/* Background glows */}
      <div className="hero-glow top-[-200px] left-[-100px]" style={{ background: '#3b82f6' }} />
      <div className="hero-glow top-[-100px] right-[-200px]" style={{ background: '#8b5cf6' }} />
      <div className="hero-glow bottom-[-200px] left-[30%]" style={{ background: '#06b6d4' }} />
